            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6" style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
                        <h3>Roadmap</h3>
                        <h5><strong>Step1 <br/> </strong>
                        Launch Tut Uncommon NFTs collection on the Cronos Chain with 5555 minted cats.A companion website is developed.</h5>
                            
                        <h5><strong>Step2 <br/> </strong>Provide Airdrop giveaways of a distinctive Tut NFT to randomly selected Tut NFT owners.Implement staking for Tut NFTs.</h5>
